...
(see \refstruc{design-specification} and \refstruc{design-specification})

\bence{Ennek szerintem a tervezés szakaszban kéne megjelennie, itt, a "graphic
	design" részben már csak hivatkozni kéne rá.  Bár mi időben 5 perc
	különbséggel beszéltünk erről a két témáról, ez két, egymástól markánsan
	elkülönülő rész.  Tervezés: célja, hogy ismerjük a funkciókat, ismerjük a
	prioritásokat.  Grafikai tervek: lássuk, hogy a fontos dolgok hogyan jelennek
	meg a felületen.  Aztán jöhet az egész szépítése.}

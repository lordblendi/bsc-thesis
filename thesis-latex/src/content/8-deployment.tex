...
\newparagraph{Gulp}\label{gulp}Gulp is a software tool to automatize tasks. I use it to concatenate and minimize files, transform HTML-like syntax in JavaScript files and move them to another directory. Gulp can be installed with the following command (npm will not work without using a node version):

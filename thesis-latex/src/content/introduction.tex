...
Sándor Gajdos wrote the specification and the students designed and implemented the portal. They used version control, but did not wrote any test. The portal has Oracle SQL basics with a PHP engine and an XSLT templating system.

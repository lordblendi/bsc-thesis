...
My objective is to design a new administration portal and implement the front end's student module. In \refstruc{specification} I introduce the specification phase. Then I compare frameworks in \refstruc{comparing-frameworks}. The conceptual system design, entity-relationship data model, front end system design will be introduced in \refstruc{conceptual}. I introduce the client's graphic design in \refstruc{graphic-design}. The deployment will be described in \refstruc{deployment}. I introduce the method of implementation in \refstruc{implementation}. The testing phase will be described and the result will be summarized in \refstruc{7-test}. And at last but not least I summarize my work in \refstruc{conclusion}.

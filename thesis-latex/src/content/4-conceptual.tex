...
The conceptual system design represents the \todo{structure} of the system. The front end design depends on which software architecture pattern is used. This project follows the MVC pattern \see{mvc}. In this chapter I am going to introduce the system design and the general MVC pattern. The front end system design will be introduced in \refstruc{frontend-system-design}, because it depends on the framework's behavior.

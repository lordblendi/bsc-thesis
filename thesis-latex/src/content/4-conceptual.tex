...
\bence{ez itt nekem elég zavaros.  minden benne van, aminek benne kell lennie, de össze-visszaság érzésem van}
...
\bence{Ez elég szarul néz ki elforgatva.  A kép címe normálisan áll, az oldalszámozás normálisan áll, a kép viszont fektetett.}
...
\bence{a külön folyamatban futtatás még nem oldja meg a megfelelő izolációt.  a lényeg pont az, hogy szétválasztott megoldás esetén megvan a lehetősége annak, hogy akár külön gépen (instance) futhasson a szerver. a kliens esetén pedig azért jó ez így, mert a kliens kódjából nem lehet következtetni az elérhető adatokra (pl. a hallgatói modul nem fog tartalmazni olyan API routing szabályokat, amiket az oktatói viszont igen.}
...
\bence{Ez is fura. Mmint, hogy fektetve van az álló oldalon az ábra.}
...
\bence{Ez az ábra nem csak az enyém.  Tele van vele a google: https://www.google.hu/search?q=mvc+architecture&safe=off&source=lnms&tbm=isch&sa=X&ved=0ahUKEwil3-6Q58XJAhVGaRQKHXZHCc4Q_AUIBygB&biw=1278&bih=702#safe=off&tbm=isch&q=asp.net+mvc+architecture&imgrc=Cg1yLL6LrpJpOM: }
\bence{Marshalling helyett talán jobb a "serialization"}
